        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mt-4 pt-2">
                <div class="card blog blog-primary rounded border-0 shadow">
                    <div class="position-relative">
                        <img src="{{asset($singleNews->image)}}" class="card-img-top rounded-top" alt="...">
                    ...
                    <div class="author">
                        <small class="date"><i class="uil uil-calendar-alt"></i> {{date('F j, Y', strtotime($singleNews->created_at))}}</small>
                    </div>
                </div>
            </div><!--end col-->
            @endforeach
