...
<div class="position-relative">
    <div class="shape overflow-hidden">
        <div class="text-center p-4">
            <h5 class="mb-0 text-white title-dark">{{date('F j, Y', strtotime($event->date))}}</h5>
        </div>
    </div>
</div>
<!-- Hero End -->
        ...
        <div class="row justify-content-center">
            <div class="col-12 text-center">
                <div class="section-title mb-4 pb-2">
                    ...
                    <p class="text-muted para-desc mx-auto mb-0">Stay Updated</p>
                </div>
            </div><!--end col-->
        </div><!--end row-->

        <div class="row">
            @foreach($event->blogs as $blog)
            <div class="col-lg-4 col-md-6 mt-4 pt-2">
                <div class="card blog blog-primary rounded border-0 shadow">
                    <div class="position-relative">
                        <img src="{{asset($blog->image)}}" class="card-img-top rounded-top" alt="...">
                    ...
                    <div class="author">
                        <small class="date"><i class="uil uil-calendar-alt"></i> {{date('F j, Y', strtotime($blog->created_at))}}</small>
                    </div>
                </div>
            </div><!--end col-->
            @endforeach
